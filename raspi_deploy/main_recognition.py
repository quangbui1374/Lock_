...
# ================== CONFIG ==================
DB_FILE = "db.json"
# ── ĐỔI ĐƯỜNG DẪN CHO PHÙ HỢP VỚI RASPBERRY PI ──
# Đặt file yolov8n-face.pt cùng thư mục với file này
# Bản Nano (n) nhẹ hơn nhiều so với bản Large (l), phù hợp cho Pi 4
MODEL_PATH = "/home/pi/smartlock/yolov8l-face.pt"
model_name = "Facenet"
